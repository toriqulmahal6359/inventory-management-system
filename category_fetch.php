<?php
    ...
    {
        $query .= 'ORDER BY '.$_POST['order']['0']['column'].' '.$_POST['column']['0']['dir'].' ';
    ...
    foreach($result as $row)
    {
        ...
        $sub_array = array();
        $sub_array[] = $_row['category_id'];
        $sub_array[] = $_row['category_name'];
        $sub_array[] = $status;
        $sub_array[] = '<button type="button" name="update" id="'.$row["category_id"].'" class="btn btn-warning btn-xs warning">Update</button>';
